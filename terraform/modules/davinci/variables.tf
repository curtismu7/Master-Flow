...
variable "pingone_agreement_master_flow_agreement_id" {
...
variable "pingone_application_dv_worker_app_oidc_options_client_id" {
}

variable "pingone_application_dv_worker_app_oidc_options_client_secret" {
}
variable "pingone_identity_provider_facebook_id" {
 
}
variable "pingone_identity_provider_google_id" {
  
}
variable "pingone_password_policy_standard_password_policy" {
}
variable "pingone_population_default_population_id" {
}
